  ...
  <table class="table">
   ...
   <c:forEach var="p" items="<%= dao.findAll() %>" > 
       <tr class="active">
         ...
         <td>${p.adresse}</td>
         <td>${p.datenaiss}</td>
         <td><a href="Elevectrl?action=modifier&nume=${p.nume}" class="btn btn-success">Modifier</a></td>
		 <td><a href="Elevectrl?action=supprimer&nume=${p.nume}" onclick="return confirm('Voulez vous supprimer')" class="btn btn-danger">Supprimer</a></td>
      </tr>
