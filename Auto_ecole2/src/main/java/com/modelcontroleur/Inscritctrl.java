...
public class Inscritctrl extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
	   ...
	   request.setAttribute("erreur","Param�tres incorrectes");
	   getServletContext().getRequestDispatcher(manage).forward(request,response);
	   }
	}
    ...
    {          
    	       ...
    	       inscrit.setId(inscritid);
    			...
    			if( action.equals("ajouter")){
    				dao.create(inscrit);
    				request.setAttribute("succes","Inscrit ajout�e avec succ�s.");
    			}
    			if( action.equals("edit")){
       				    	dao.create(inscrit);
       				    	request.setAttribute("succes","Inscrit modifi�e avec succ�s.");
    			}
    ...
    else
    {
    	if( action != null && !"".equals(action))
    	{
    		...
    		// on le r�dirige vers la page de manage avec un message d'erreur
